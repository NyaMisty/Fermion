...
fridaLatestRelease = requests.get('https://api.github.com/repos/frida/frida/releases/latest').json()
...
fermionTag = "v%s-frida%s-gumjs%s" % (fermionVer, fridaVer, fridaGumVer)
